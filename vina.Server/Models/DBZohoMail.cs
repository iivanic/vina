...
public class DBZohoMail
{
    ...
    public const string InsertText = "insert into zoho_mail ( authorization_code, authorization_location, authorization_accountsServer, authorization_code_timestamp, access_token, access_token_type, access_token_timestamp, access_token_expires_in, access_token_valid_until, refresh_token) values(@authorization_code, @authorization_location, @authorization_accountsServer, @authorization_code_timestamp, @access_token, @access_token_type, @access_token_timestamp, @access_token_expires_in, @access_token_valid_until, @refresh_token)  returning *;";
